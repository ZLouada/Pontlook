    ...
    <section className="border-y border-slate-200/60 bg-slate-50/50 py-10">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeIn direction="none" delay={0.2} className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
          <p className="text-sm font-semibold uppercase tracking-wider text-slate-400 text-center md:text-left max-w-[200px]">
            Tapping into the <span className="text-slate-700">$1.2B</span> Pontlook Corporate Training Market
          </p>
