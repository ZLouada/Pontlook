...
export function ProvidersTeaser() {
  return (
    <section className="py-32 bg-[var(--bg-base)] relative overflow-hidden border-b border-[var(--border-default)]">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          
          <div className="order-2 lg:order-1">
            <FadeIn direction="right" delay={0.2}>
              <div className="bg-[var(--surface-card)] border border-[var(--border-default)] rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/5 dark:shadow-black/20">
                <h3 className="text-2xl font-bold tracking-tight text-[var(--fg-heading)] mb-10">Lead Quality Tiers</h3>
              ...
              <FadeInStaggerItem>
                <ul className="space-y-5 mb-12">
                  {["Access exclusively to verified UAE & Middle East companies", "Detailed intelligence before you accept a lead", "100% replacement guarantee on bad data"].map((item, i) => (
                    <li key={i} className="flex items-start gap-4 text-lg text-[var(--fg-default)] font-medium">
