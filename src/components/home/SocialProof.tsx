...
export function SocialProof() {
  ...
  return (
    <section className="py-12 md:py-20 bg-primary-900 dark:bg-[var(--bg-muted)] text-white relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 text-center divide-x divide-primary-800 dark:divide-[var(--border-default)]">
